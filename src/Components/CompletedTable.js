        ...
        <tbody className=" border-2 border-gray-600 rounded-md p-5">
          {filteredData.map((item, index) => (
            <tr key={index}>
              ...
              <td className="sm:p-3 py-1 px-1 border-b border-gray-200">
              <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" className="mt-3 cursor-pointer pr-5 mb-4">
