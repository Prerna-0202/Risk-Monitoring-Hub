...
import Table from "@/Components/PendingTable";
  ...
  return (
    <main className="flex">
      ...
      <div className="flex-grow md:ml-72">
        <div className="sm:px-7 sm:pt-7 px-4 pt-4 flex flex-col w-full border-b border-gray-200 bg-white sticky top-0 z-30">
          ...
          <div className="flex items-center space-x-3 sm:mt-7 mt-4">
            <Link href="#" className="px-3 border-b-2 border-blue-500 text-blue-500 pb-1.5">Pending</Link>
            <Link href="/Monitoring/Completed" className="px-3 border-b-2 border-transparent text-gray-600 pb-1.5">Completed</Link>
